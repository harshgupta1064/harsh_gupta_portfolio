...
sr.reveal('.home__data, .about__img, .skills__subtitle, .skills__text',{opacity: 1}); 
sr.reveal('.home__img, .about__subtitle, .about__text, .skills__img',{delay: 400, opacity: 1}); 
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof projectManager !== 'undefined') {
        ...
        console.error('Project manager not found. Make sure project-data.js is loaded before main.js');
    }
});
